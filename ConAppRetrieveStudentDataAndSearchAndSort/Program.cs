...
namespace ConAppRetrieveStudentDataAndSearchAndSort
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string filePath = @"D:\Mphasis\Live Session\SimpliLearn Projects\Practice Projects\ConAppRetrieveStudentDataAndSearchAndSort\student_data.txt";
            ...
            while (shouldContinue)
            {
                ...
                else
                {
                    ...
                    {
                        Console.WriteLine($"Found: Student ID: {foundStudent.StudentID}, Name: {foundStudent.Name}, Grade: {foundStudent.Grade}");
                    }
                    else
                    {
