...
namespace Phase2SchooDbWebAPI.Controllers
{
    ...
    {
        private readonly APISchooDbContext _context;

        public StudentsController(APISchooDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Students>> PostStudents(Students students)
        {
          if (_context.Students == null)
          {
              return Problem("Entity set 'APISchooDbContext.Students'  is null.");
          }
